...
// Ported verbatim (JS -> TS) from the react-bits "GradientWaves" component -
// a raymarched plasma/ocean shader rendered via ogl (already a project
// dependency, used the same way in CircularGallery.tsx).
