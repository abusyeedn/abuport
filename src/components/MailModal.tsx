...
export default function MailModal({ isOpen, onClose, onSuccess }: MailModalProps) {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      // Only play the fly-away animation once the email has actually sent.
      if (modalRef.current) {
        ...
        {isOpen && !isSending && (
          ...
          >
            ...
            >
              ...
              <img 
                src="/gallery/home/envelope-opened.png" 
                alt="Opened Envelope" 
                style={{ 
                  width: '100%', 
                  height: '100%', 
              ...
              >
                ...
                {error && (
                  <FigmaElement
                    figmaId="mail-error"
                    style={{ display: 'block', width: '480px', top: '500px', left: '210px' }}
                  >
