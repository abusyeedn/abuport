...
// Current page-wide zoom scale (1024–1440px range), exposed so persistently-visible
// UI like the Dock nav can cancel it out and stay pinned at native size in every corner
