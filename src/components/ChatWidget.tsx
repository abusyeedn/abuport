...
const QUESTION_POOL = [
  { label: "What's his role at Kynhood, exactly?",       prompt: "What is Abusyeed's current role at Kynhood, and what are his day-to-day responsibilities there?" },
  { label: 'Numbers that back up his impact?',           prompt: "What are Abusyeed's top career achievements, specifically with real numbers attached?" },
  ...
  const runCommand = (cmd: string) => {
    ...
    if (cmd === '/email') {
      setMessages(m => [...m,
        ...
        { role: 'assistant', content: 'Reach Abu at abusyeed10202@gmail.com' }
      ])
      setInput('')
      return
    }
                      ...
                      <AnimatePresence mode="popLayout">
                        {activeQuestions.map((q, qi) => (
                          <motion.button key={q.label}
                            ...
                            animate={{ opacity: 1, scale: 1, y: 0, transition: { type: 'spring', stiffness: 420, damping: 22, delay: qi * 0.07 } }}
                            ...
                            style={{
                              ...
                              transition: 'background 0.15s, border-color 0.15s, color 0.15s', fontFamily: FONTS.primary,
                            }}
