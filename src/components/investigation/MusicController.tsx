 ...
 * - Case 1 / Intro (Memory Reconstruction): Ezio's Family (Mysterious, atmospheric)
 * - Case 2 (Memory Network): Venice Rooftops (Fast, rhythmic)
 * - Case 3 (The Lost Memory): Florence Tarantella (Playful, busy)
 * - Case 4 (Profile Reconstruction): Approaching Target (Tense, focused)
 * - Case 5 (Finale): Earth (Majestic, celebratory resolution)
 */
