...
// Ported (JS -> TS) verbatim - a mechanical split-flap/departure-board text
// component. Used for the hero "impact numbers" (50+, ₹5 Cr+, 5,000+): each
// stat settles in via a flip-scramble instead of appearing as static text.
export default function SplitFlapText({
  ...
  useEffect(() => {
    ...
    type Plan = { index: number; from: string; target: string; sequence: string[]; start: number; step: number; done: boolean }
