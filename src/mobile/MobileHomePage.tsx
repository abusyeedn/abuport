...
function MobileWorkCard({ image, imageFit, title, description, onClick }: { image: string; imageFit?: 'cover' | 'contain'; title: string; description: string; onClick: () => void }) {
  ...
  return (
    ...
    >
      ...
      <h3 style={{ margin: 0, fontFamily: FONTS.display, fontSize: MOBILE_TYPE.lg, fontWeight: 700, letterSpacing: '-0.01em', color: COLORS.textPrimary }}>
        {title}
      </h3>
...
export default function MobileHomePage() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column' }}>
      <div style={{ padding: `1.25rem ${sidePad} 0` }}>
        <MobileHero onViewJourney={() => navigate('/kynhood2')} />
      </div>
